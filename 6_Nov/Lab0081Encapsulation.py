#Encapsulation : Describes as the idea of wrapping data & the methods that work on data within one unit
...
# Public
obj.public_method() #able to access outside
#Protected
obj._protected_method() # partialy acess outside

#obj.__private_method() # noyt able to access
